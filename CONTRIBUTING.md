...
1. All the screens must have individual folder in the Containers folder
   a. Folder name in Pascal case
   b. File name in Pascal case
   c. Add individual css in [CSS Modules Stylesheet](https://create-react-app.dev/docs/adding-a-css-modules-stylesheet/)
