    ...
    <>
      <div className="signup_main">
        ...
        <form className="SignUpform">
          ...
          {error.email && <div className="errorSignup"><RiCloseFill size={18}/>{error.email}</div>}
          ...
          value={inp.cemail}
          onChange={handleInp}></input><br/>    
          {error.cemail && <div className="errorSignup"><RiCloseFill size={18}/>{error.cemail}</div>}
          ...
          value={inp.password}
          onChange={handleInp}></input><br/>    
          {error.password && <div className="errorSignup"><RiCloseFill size={18}/>{error.password}</div>}
          ...
          <div className="dobSignUp">
            <div className='dobYearSignUp'>
              ...
              {error.year && <div className="errorSignup"><RiCloseFill size={18}/>{error.year}</div>}
            </div>
            ...
            <div className='dobMonthSignUp'>
              ...
              onChange={handleInp}>
                ...
                {error.month && <div className="errorSignup"><RiCloseFill size={18}/>{error.month}</div>}
            </div>
            ...
            <div className="dobDaySignUp"> 
              ...
              value={inp.day}
              onChange={handleInp}></input>
              {error.day && <div className="errorSignup"><RiCloseFill size={18}/>{error.day}</div>}
            </div>  
          </div>
          ...
          {error.gender && <div className="errorSignup"><RiCloseFill size={18}/>{error.gender}</div>}
          <br/>
